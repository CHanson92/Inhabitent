 ...
 *
 * Widget to edit the business hours on our custom made theme.
 *
 * Lightly forked from the WordPress Widget Boilerplate by @tommcfarlin.
 *
 * @package   Inhabitent_Business_Hours
 * @author    Chris Hanson <blondyhanson@gmail.com>
 * @license   GPL-2.0+
 * @link      
 ...
 * Description:       A nifty business hours widget built for the Inhabitent site.
 * Version:           1.0.0
 * Author:            Chris Hanson
...
class Inhabitent_Business_Hours extends WP_Widget {
     ...
     * @var      string
     */
    protected $widget_slug = 'inhabitent-biz-hours';
